    ...
    <div>
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-3">
          <h2 className="font-display text-2xl font-semibold">Guest Reviews</h2>
          {averageScore > 0 && (
            <div className="flex items-center gap-1.5 bg-navy/10 text-navy px-3 py-1 rounded-full">
          ...
          return (
            ...
            >
              <div className="flex items-start justify-between">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-full bg-navy/10 flex items-center justify-center overflow-hidden">
                    {flag ? (
                ...
                {review.score && (
                  <div className="bg-navy text-white px-2 py-1 rounded-md text-sm font-bold">
                    {review.score}
                  </div>
                )}
              </div>
              ...
              {review.positive_text && (
                <div className="flex gap-2">
                  <Quote className="h-4 w-4 text-navy flex-shrink-0 mt-0.5" />
